...
class Product(models.Model):
    ...
    image=models.ImageField(upload_to="products/uploads/products")
    ...
    def get_all_images(self):
        images=f"<img src='{self.image.url}' height='25' width='25' style='border-radius:50%;'> - "
...
class Order(models.Model):
    ...
    def product_list(self):
        ...
        for i in text:
           ...
           data+=f"<img src='{obj.image.url}' style='height:25px;weight:25px;border-radius:50%;'> {Product.objects.get(id=i['id']).title}( {i['quantity']} )<br>"
